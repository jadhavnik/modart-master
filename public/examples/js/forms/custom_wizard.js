...
(function (document, window, $) {
    ...
    $(document).ready(function ($) {
        ...
        //     $('#personalTabForm').formValidation('revalidateField', 'birthday');
        // });
        ...
        $("#drpdwn_roles").on('change', (function () {
            ...
            // var is_company = val.indexOf("Confirmer") >= 0;
    ...
    (function () {
        ...
        $("#personalTabForm#companyTab").formValidation({
            framework: 'bootstrap',
            fields: {
...
//                            }
        ...
        var wizard = $("#profileForm").wizard(options).data('wizard');
        ...
        wizard.get("#companyTab").setValidator(function () {
            var fv = $("#companyTab#companyTabForm").data('formValidation');
            fv.validate();
